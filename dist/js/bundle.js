...
$(function () {
  ...
  var API_KEY = '16188136-cb26e8587dca641fa7a44fc3b';
  var $mosaicImgShort = $('[data-section]');
  ...
  function getInput() {
    var $search = $('.search');
    var $inputType = $('.search_line');
    var $inputTypeText = $inputType.val();
    var $searchResult = $('.search_result');
    var $findImg = $('.find-img');
    $.getJSON(getURL($inputTypeText), function (data) {
      console.log('$inputTypeText', $inputTypeText);

      if (parseInt(data.totalHits) > 0) {
        var randomIndex = randomInteger(0, data.hits.length - 1);
